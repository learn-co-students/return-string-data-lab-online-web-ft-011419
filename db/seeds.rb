...
10.times do
  products = ["tv", "vcr", "macbook", "macbook air", "mouse", "chair", "desk", "lamp", "water bottle"]
  Product.create(:name => products.sample, :price => Faker::Number.between(1,1500), :description => "This is a test string. Please do not take this seriously. I am serious. Please.", :inventory => Faker::Number.between(0,20))
end
5.times do
